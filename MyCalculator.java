...
String specialButtonText[] = {"Delete", "C", "CE" };  
...
final int FRAME_WIDTH=420,FRAME_HEIGHT=500;  
final int HEIGHT=30, WIDTH=40, H_SPACE=13,V_SPACE=20;  
...
displayLabel.setBounds(50,60,310,70);  
...
tempX=TOPX+1*(WIDTH+H_SPACE); y=TOPY+3*(HEIGHT+V_SPACE);  
for(int i=0;i<specialButton.length;i++) 
{  
memoryButton[i]=new MyMemoryButton(tempX,y,WIDTH*2,HEIGHT,memoryButtonText[i], this);  
memoryButton[i].setForeground(Color.BLACK); 
tempX=tempX+2*WIDTH+H_SPACE; 
  
}  

tempX=TOPX+1*(WIDTH+H_SPACE); y=TOPY+2*(HEIGHT+V_SPACE);  
for(int i=0;i<specialButton.length;i++)  
{  
...
int digitY=TOPY+4*(HEIGHT+V_SPACE);  
